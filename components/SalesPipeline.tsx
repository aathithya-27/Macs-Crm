...
const KanbanCard: React.FC<{
    ...
    return (
        <div 
            ...
            className={`bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm border-2 border-gray-300 dark:border-gray-700 ${canModify ? 'cursor-grab active:cursor-grabbing' : 'cursor-pointer'} transition-all duration-200 ${
        ...
        <div className="space-y-6">
            ...
            <div className="flex gap-4 overflow-x-auto pb-4 h-[calc(100vh-20rem)] min-h-[700px]">
                ...
                <div className="w-80 flex-shrink-0 flex flex-col gap-4">
                    <div className="h-1/2">
                        <DropZone 
                            label="Drag here to convert to customer" 
                    ...
                    <div className="h-1/2">
                        <DropZone 
                            label="Drag here to mark as lost" 
