...
interface NotificationDropdownProps {
  ...
  onViewAll: () => void;
  onClearAll: () => void;
  onDismissItem: (notificationId: string) => void;
}
...
const NotificationDropdown: React.FC<NotificationDropdownProps> = ({ notifications, isCleared, onViewAll, onClearAll, onDismissItem }) => {
                        ...
                        <li key={notification.id} className="flex items-center justify-between p-3 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-150">
                            <button onClick={onViewAll} className="flex-grow flex items-start gap-3 text-left">
                             ...
                             <button
                                ...
                                aria-label={`Dismiss notification for ${notification.member.name}`}
                            >
                                 <X size={14} />
                            </button>
                        </li>
