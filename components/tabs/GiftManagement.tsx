...
const GiftManagement: React.FC<GiftManagementProps> = ({ gifts, giftMappings, onUpdateGifts, onUpdateGiftMappings, addToast }) => {
    ...
    const handleMappingChange = (tier: string, giftId: string) => {
    ...
    return (
        <div className="space-y-8">
            <div>
                ...
                <p className="text-gray-500 dark:text-gray-400 mt-1">Manage master gifts and assign them to Customer Type.</p>
            </div>
