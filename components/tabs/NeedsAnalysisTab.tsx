...
export const NeedsAnalysisTab: React.FC<NeedsAnalysisTabProps> = ({ data, onChange, addToast, permissions }) => {
    ...
    <div className="flex flex-col lg:flex-row gap-8">
      ...
      <div className="lg:w-1/3 flex-shrink-0">
        <div className="space-y-6">
            ...
            <Button onClick={handleGenerateReport} disabled={isLoading || !canModify} className="w-full">
