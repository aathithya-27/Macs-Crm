                    ...
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border dark:border-gray-700">
                        ...
                        <div className="space-y-3">
                            <Button 
                                ...
                                disabled={!canCreate}
                                title={!canCreate ? "You don't have permission to create employees" : "Create a new employee profile"}
                            >
                                <UserPlus size={16}/> Create New Employee
                            </Button>
                            <h4 className="text-sm font-semibold text-gray-600 dark:text-gray-300 pt-3">Recently Added Employees:</h4>
                            {recentEmployees.length > 0 ? (
                                ...
                                <p className="text-sm text-gray-500 dark:text-gray-400 text-center py-2">No employees created yet.</p>
                            )}
                        </div>
                    </div>
                </div>
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border dark:border-gray-700">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            <StatCard icon={<Users size={20} />} label="Total Employees" value={users.length} color="bg-blue-100 text-blue-600 dark:bg-blue-900/40" />
