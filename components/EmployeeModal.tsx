...
// MODIFIED: Added DesignationPermissions
import { User, EmployeeProfile, EmployeeModalTab, Member, FinRootsBranch, Geography, BankMaster, BusinessVertical, InsuranceTypeMaster, AMC, Designation, DesignationPermissions } from '../types.ts';
        ...
        <Modal isOpen={isOpen} onClose={onClose}>
            ...
            <div className="flex-grow overflow-y-auto p-6">
                ...
                <div className="mt-8">
                    ...
                    <div className="pt-6">
                        {activeTab === EmployeeModalTab.GeneralInfo && <GeneralInfoTab data={formData} onChange={handleChange} onSave={onSave} finrootsBranches={finrootsBranches} addToast={addToast} bankMasters={bankMasters} businessVerticals={businessVerticals} insuranceTypes={insuranceTypes} amcs={amcs} designations={designations} permissions={{}} />}
