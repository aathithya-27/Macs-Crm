...
const LeadSourceSelector: React.FC<LeadSourceSelectorProps> = ({ value, onLeadSourceChange, leadSources, allMembers, currentMemberId, referrerId, onReferrerSelect, onAddNewReferrer, disabled = false }) => {
                    ...
                    {showReferrerField && allMembers && onReferrerSelect ? (
                        <div>
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                {onAddNewReferrer && (
                                <Button variant="light" onClick={onAddNewReferrer} className="flex-shrink-0 !h-10" disabled={disabled}>
