...
const DocumentHub: React.FC<DocumentHubProps> = ({ templates, onUpdateTemplates, isReadOnly = false }) => {
        ...
        <div className="lg:col-span-1">
          <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm border dark:border-gray-700">
            <div className="flex justify-between items-center mb-4">
              ...
              <Button onClick={handleCreateNew} size="small" variant="success" disabled={isReadOnly}>
                <Plus size={14} /> New
              </Button>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border dark:border-gray-700 animate-fade-in">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-end gap-3">
                  ...
                  <Button onClick={handleSave} variant="primary" disabled={isReadOnly}><Save size={16} /> Save Template</Button>
                </div>
              </div>
            </div>
          ) : (
